...
import InstallItem from './InstallItem.vue';
import { installAsApp } from '../utilities/pwa';

function openExtension() {
    window.open('https://chromewebstore.google.com/detail/calculite/pafhgocalnhibemiifonjnmddgmoedhc');
}
</script>
